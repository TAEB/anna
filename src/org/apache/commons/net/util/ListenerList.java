...
public class ListenerList implements Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3426103967686840615L;
	private Vector<EventListener> __listeners;

    public ListenerList()
    {
        __listeners = new Vector<EventListener>();
    }
    ...
    {
        return ((Vector<EventListener>)__listeners.clone()).elements();
    }
